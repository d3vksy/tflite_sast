...
정상 모델 15개(B001-B015)와 취약점 주입 모델 7개(M001-M007) 생성.
"""
...
def make_m006_r001_r002_combo() -> bytes:
    """M006: R001+R002 복합 패턴"""
    b = FlatBufferBuilder()
    buf_offs = [build_buffer(b), build_buffer(b, b'\x01\x02\x03\x04')]
    oc_offs  = [build_opcode(b, 0, deprecated=0)]
...
def make_m007_r003_r004_r005_combo() -> bytes:
    """M007: R003(SPLIT_V axis OOB)+R004(SparseAdd)+R005(While) 복합 패턴"""
    import struct as _struct
    b = FlatBufferBuilder()
...
MODEL_SPECS = [
    ...
    ('M005.tflite', 'R005: While body=cond 동일',            make_m005_r005_while_same_subgraph),
    ('M006.tflite', 'R001+R002 복합',                        make_m006_r001_r002_combo),
    ('M007.tflite', 'R003+R004+R005 복합',                   make_m007_r003_r004_r005_combo),
]
